...
angular.module('selectize', []).value('selectizeConfig', {}).directive("selectize", ['selectizeConfig', function(selectizeConfig) {
    return {
      ...
      link: function(scope, element, attrs, modelCtrl) {
        console.log('This also happens since we are using the new stuff');
        var selectize,
        ...
        var setSelectizeValue = function() {
          validate();
          console.log('This happens since we are using the new stuff 2');
        ...
        settings.onChange = function(value) {
          ...
          console.log('This happens since we are using the new stuff');
        ...
        settings.onInitialize = function() {
            console.log('This initializes since we are using the new stuff');
